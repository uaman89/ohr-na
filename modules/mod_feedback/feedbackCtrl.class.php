    ...
    */
    function show(){
       ...
       ?>
        ...
        <td class="THead"><?=$this->Form->LinkSort( $this->sort, 'id', $script2, $this->asc_desc, $this->multi['FLD_ID']);?></Th>
        <?if($this->is_files==1){?>
            <td class="THead"><?=$this->Form->LinkSort( $this->sort, 'fpath', $script2, $this->asc_desc, $this->multi['ATTACHED_FILE']);?></Th>
        <?}?>
        <td class="THead"><?=$this->Form->LinkSort( $this->sort, 'f_name', $script2, $this->asc_desc, $this->multi['_FLD_F_NAME']);?></Th>
        <?if($this->is_email==1){?>
        <td class="THead"><?=$this->Form->LinkSort( $this->sort, 'e_mail', $script2, $this->asc_desc, $this->multi['_FLD_E_MAIL']);?></Th>
            <?}?>
        <Th class="THead"><?=$this->multi['_FLD_MESSAGE'];?></Th>
        <td class="THead" ><?=$this->Form->LinkSort( $this->sort, 'date', $script2, $this->asc_desc, $this->multi['_FLD_DATE']);?></Th>
        <td class="THead"><?=$this->Form->LinkSort( $this->sort, 'refpage', $script2, $this->asc_desc, $this->multi['TRACK_CONTACT']);?></Th>
        <?
        $style1 = 'TR1';
        $style2 = 'TR2';
        for( $i = 0; $i < $rows; $i++ )
        {
          ...
          <tr class="<?=$class_tr;?>">
            ...
            <?}?>
            <td align="left"><?=stripslashes($row['f_name']);
