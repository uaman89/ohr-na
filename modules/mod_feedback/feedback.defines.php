...
include_once( SITE_PATH.'/modules/mod_feedback/feedback_settings.class.php' );
...
define("TblModFeedbackSet","mod_feedback_set");

//------------ defines for Files ----------------
define("FeedbackUseFiles", "0");
define("FeedbackUseCaptcha", "0");
define("FeedbackSendFormAjax", "1");
