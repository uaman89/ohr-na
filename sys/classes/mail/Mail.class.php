...
include_once( SITE_PATH.'/sys/classes/mail/class.phpmailer.php' );
 ...
 function Mail($lang_id=NULL)
 {
  ...
  $sett['mail_header'] = stripslashes($sett['txt'][$this->lang_id]['head']);
  $sett['mail_footer'] = stripslashes($sett['txt'][$this->lang_id]['foot']);
  ...
  if( !empty($sett['mail_footer']) ){
      $this->BodyFooter = $sett['mail_footer'].'</body></html>';
      /*
