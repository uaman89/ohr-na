...
// ================================================================================================
 class SysLang {
       ...
       // Change Request Nbr:
       // ================================================================================================
       static function GetCountLang( $back_front='back' )
       {
       ...
       function LangArray( $lang_id = NULL, $back_front='back' )
       {
        ...
        $q = "SELECT `".TblModSysLang."`.cod, `".TblModSysLangSpr."`.name FROM `".TblModSysLang."`, `".TblModSysLangSpr."`
...
//        print_r($mas);
       ...
       function WriteLangPanelShort($lang_id=NULL, $is_img = false)
       {
        ...
        // Change Request Nbr:
        // ================================================================================================
        static function GetDefBackLangData()
        {
            $tmp_db = DBs::getInstance();
        ...
        // Change Request Nbr:
        // ================================================================================================
        static function GetDefBackLangID()
        {
            $tmp_db = DBs::getInstance();
            $q = "select * from `".TblModSysLang."` where `def_back`='1'";
            $res = $tmp_db->db_Query($q);
        ...
        // Change Request Nbr:
        // ================================================================================================
         static function GetDefFrontLangID()
        {
            $tmp_db = DBs::getInstance();
        ...
        // Change Request Nbr:
        // ================================================================================================
        static function GetDefLangEncoding( $lang_id = NULL )
        {
            $tmp_db = DBs::getInstance();
        ...
        // Change Request Nbr:
        // ================================================================================================
        static function GetLangShortName( $lang_id )
        {
            $tmp_db = DBs::getInstance();
        ...
        // Change Request Nbr:
        // ================================================================================================
        static function GetLangCodByShortName( $name )
        {
            $tmp_db = DBs::getInstance();
