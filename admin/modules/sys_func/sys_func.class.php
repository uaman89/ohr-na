    		...
    		<tr>
                    ...
                    <td>
                        <ul>
                            ...
                            <li>usecolors - указание цвета</li>
                            <li>usecodpli - код для синхронизации с внешними программами</li>
                            <li>usemeta - мета данные</li>
                            <li>usetranslit - транслитерация для построения УРЛ</li>
                            <li>usedescr - текстовое описание</li>
                            <li>useshort - краткое название</li>
                            <li>useimg - закгрузка изображения одного к каждой языковой версии</li>
                            <li>usehref - ссылка</li>
                            <li>usevisible - отображать/не отображать</li>
