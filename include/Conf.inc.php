...
if( strstr($_SERVER['SERVER_NAME'], '.seotm.biz') ){
    ...
    define("_PASSWD", "ohrana"); // Password to access the database
}
else{
    define("_HOST", "localhost"); // Hostname of the server
    define("_DBNAME", "ohrana_ua"); // Database Name
    define("_USER","ohrana_ua"); // User to access the database
    define("_PASSWD", "WaG6CqsQ"); // Password to access the database
}
