    ...
    function ShowContentCurentLevel($lable=false)
      {
        ...
        if ($this->isContent > 0) {
            ...
            $props = $this->ShowListOfContentByPages( $this->GetListPositionsSortByDate($this->id_cat, 'limit', $this->sort, $this->asc_desc, true, $this->id_param, '', '', $lable) );
...

    {
      ...
      // echo '<br> $q='.$q.' $res='.$res.' $tmp_db->result='.$tmp_db->result;
        ...
        <div class="tovarImage float-to-left width40">
            <!-- display image start-->
                ...
                <div class="tovar-detail">
                    ...
                    ?> <div class="new_price"><?= $this->Currency->ShowPrice($price_group); ?></div>
                        <?php
        ...
        <div class="fullDesc">
            ...
            $arrP = $this->GetRelatProp($this->id, TblModCatalogPropRelat, true);
...
// ================================================================================================
        ...
        <div class="props-tab">
            ...
            <div class="relat-prop-slider">
                ...
                foreach ($arr as $key => $value) {
                    ...
                    $short = strip_tags($this->Spr->GetNameByCod(TblModCatalogPropSprShort, $id_relat));
                    ?>
                    <div class="prod">
                        ...
                        if (isset($img) AND !empty($img)) {
                            ...
                            ?>
                            <a class="img-prod-link" href="<?= $link; ?>"><img src="<?= $imgSmall; ?>"/></a>
                        <?

                        } else {
                            ?>
                            <a href="<?= $link; ?>" alt="<?= $name; ?>" title="<?= $this->multi['TXT_NO_IMAGE'] ?>">
                                <img src="/images/design/no-image.gif"/>
                            </a>
                        <?
                        }
    ...
    // ================================================================================================
    function BestProducts($limit = null, $fltr_id = 2, $informer = false)
    {
        ob_start();
        switch ($fltr_id) {
            case '1':
